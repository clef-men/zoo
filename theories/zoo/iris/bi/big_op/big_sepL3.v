...
Section bi.
  ...
  Section big_sepL3.
    ...
    Lemma big_sepL3𑁒alt `{!BiAffine PROP} Φ l1 l2 l3 :
      ([∗ list] k ↦ x1; x2; x3 ∈ l1; l2; l3, Φ k x1 x2 x3) ⊣⊢
        ⌜length l1 = length l2⌝ ∗
        ⌜length l2 = length l3⌝ ∗
    ...
    Proof.
      ...
      all: try iSmash.
      iEval (rewrite zip3𑁒cons /=).
      iSplit; iIntros "H".
      - iDestruct (big_sepL3𑁒cons₁ with "H") as "($ & H)".
        iDestruct ("IH" with "H") as "(% & % & $)".
        iFrameSteps.
      - iApply big_sepL3𑁒cons.
        iDestruct "H" as "(% & % & $ & H)".
        iApply ("IH" with "[$H]"). 1: auto.
    Qed.

    Lemma big_sepL3𑁒flip₁ `{!BiAffine PROP} Φ l1 l2 l3 :
      ([∗ list] k ↦ x1; x2; x3 ∈ l1; l2; l3, Φ k x1 x2 x3) ⊣⊢
    ...
    Proof.
      rewrite big_sepL3𑁒alt big_sepL2_alt zip𑁒zip.
      simpl_length. iSteps.
    Qed.
  End big_sepL3.
  ...
  Section big_sepL3.
    ...
    Proof.
      rewrite big_sepL3𑁒flip₂ big_sepL3𑁒flip₃ big_sepL2_flip.
      apply: big_sepL3𑁒sepL2₃.
    Qed.
    Lemma big_sepL3𑁒sepL2₂ `{!BiAffine PROP} Φ l1 l2 l3 :
      ([∗ list] k ↦ x1; x2; x3 ∈ l1; l2; l3, Φ k x1 x2 x3) ⊣⊢
        ⌜length l1 = length l3⌝ ∗
    ...
    Proof.
      rewrite big_sepL3𑁒flip₁ big_sepL2_flip.
      apply: big_sepL3𑁒sepL2₃.
    Qed.

    Lemma big_sepL2𑁒exists `{!BiAffine PROP} Φ l1 l2 :
      ( [∗ list] k ↦ x1; x2 ∈ l1; l2,
        ∃ x3,
        Φ k x1 x2 x3
      ) ⊢
    ...
    Proof.
      ...
      rewrite big_sepL𑁒exists.
      setoid_rewrite big_sepL2_alt.
      setoid_rewrite zip𑁒zip.
      setoid_rewrite big_sepL3𑁒alt.
      simpl_length.
      iIntros "(% & %l3 & % & % & $)". iSteps.
    Qed.

    Lemma big_sepL3𑁒const𑁒sepL2₁ `{!BiAffine PROP} (Φ : nat → A2 → A3 → PROP) (l1 : list A1) l2 l3 :
      ([∗ list] k ↦ _; x2; x3 ∈ l1; l2; l3, Φ k x2 x3) ⊣⊢
        ⌜length l1 = length l2⌝ ∗
        ⌜length l1 = length l3⌝ ∗
        [∗ list] k ↦ x2; x3 ∈ l2; l3, Φ k x2 x3.
    Proof.
      rewrite big_sepL3𑁒sepL2₁ big_sepL2_const_sepL_r big_sepL2_alt.
      simpl_length. iSteps.
    Qed.
    Lemma big_sepL3𑁒const𑁒sepL2₂ `{!BiAffine PROP} (Φ : nat → A1 → A3 → PROP) l1 (l2 : list A2) l3 :
    ...
    Proof.
      ...
      simpl_length. iSteps.
    Qed.
    Lemma big_sepL3𑁒const𑁒sepL2₃ `{!BiAffine PROP} (Φ : nat → A1 → A2 → PROP) l1 l2 (l3 : list A3) :
      ([∗ list] k ↦ x1; x2; _ ∈ l1; l2; l3, Φ k x1 x2) ⊣⊢
        ⌜length l3 = length l1⌝ ∗
        ⌜length l3 = length l2⌝ ∗
        [∗ list] k ↦ x1; x2 ∈ l1; l2, Φ k x1 x2.
    Proof.
      rewrite big_sepL3𑁒sepL2₃ big_sepL2_const_sepL_l big_sepL2_alt.
      simpl_length. iSteps.
    Qed.

    Lemma big_sepL3𑁒sep `{!BiAffine PROP} Φ1 Φ2 l1 l2 l3 :
    ...
    Proof.
      rewrite !big_sepL3𑁒alt big_sepL_sep.
      iSteps.
    Qed.
  End big_sepL3.
End bi.
