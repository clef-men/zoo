...
Notation "'sstore_2٠ref_gen'" := (
  in_type "zoo_data.sstore_2.ref" 0
)(in custom zoo_field
).
Notation "'sstore_2٠ref_value'" := (
  in_type "zoo_data.sstore_2.ref" 1
)(in custom zoo_field
).

Notation "'sstore_2٠Root'" := (
  in_type "zoo_data.sstore_2.descr" Tag0
)(in custom zoo_tag
).
Notation "'sstore_2٠Diff'" := (
  in_type "zoo_data.sstore_2.descr" Tag1
)(in custom zoo_tag
).

Notation "'sstore_2٠gen'" := (
  in_type "zoo_data.sstore_2.t" 0
)(in custom zoo_field
).
Notation "'sstore_2٠root'" := (
  in_type "zoo_data.sstore_2.t" 1
)(in custom zoo_field
).

Notation "'sstore_2٠snapshot_store'" := (
  in_type "zoo_data.sstore_2.snapshot" 0
)(in custom zoo_proj
).
Notation "'sstore_2٠snapshot_gen'" := (
  in_type "zoo_data.sstore_2.snapshot" 1
)(in custom zoo_proj
).
Notation "'sstore_2٠snapshot_root'" := (
  in_type "zoo_data.sstore_2.snapshot" 2
)(in custom zoo_proj
).
