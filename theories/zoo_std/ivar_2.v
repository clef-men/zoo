...
Module base.
  Section ivar_2_G.
    ...
    Lemma ivar_2_consumer_divide {t γ Ψ Ξ Χ} Χs :
      ivar_2_inv t γ Ψ Ξ -∗
      ivar_2_consumer γ Χ -∗
      (∀ v, Χ v -∗ [∗ list] Χ ∈ Χs, Χ v) ={⊤}=∗
...
Section ivar_2_G.
  ...
  #[local] Instance : CustomIpatFormat "synchronized" :=
    " ( %l{;_} &
        %γ{;_} &
        {%Heq{};->} &
        #Hmeta{_{}} &
  ...
  Proof.
    ...
    iDestruct (meta_agree with "Hmeta_1 Hmeta_2") as %->.
    iDestruct (base.ivar_2_consumer_divide with "Hinv_1 Hconsumer_2 H") as "H".
    iApply (big_sepL_impl with "H").
    iSteps.
  Qed.
