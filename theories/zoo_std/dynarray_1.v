...
Section zoo_G.
  ...
  Proof.
    iIntros "%Φ _ HΦ".
    wp_apply (dynarray_1_create𑁒spec' with "[//]").
    iSteps.
  Qed.

  Lemma dynarray_1_make𑁒spec sz v :
    (0 ≤ sz)%Z →
    {{{
      True
    }}}
  ...
  Proof.
    ...
    wp_rec.
    wp_apply+ (array_unsafe_make𑁒spec with "[//]") as "%data Hmodel"; first done.
    iSteps.
    - simpl_length.
    - iExists 0. rewrite right_id Nat2Z.id. iSteps.
  Qed.

  Lemma dynarray_1_initi𑁒spec Ψ sz fn :
    (0 ≤ sz)%Z →
    {{{
      ▷ Ψ 0 [] ∗
      □ (
  ...
  Proof.
    ...
    wp_rec.
    wp_apply+ (array_unsafe_initi𑁒spec (λ _, Ψ) with "[$HΨ]") as "%data %vs (%Hvs & Hmodel & HΨ)"; [done | iSteps |].
  ...
  Proof.
    ...
    wp_apply (dynarray_1_initi𑁒spec Ψ' with "[$HΨ Hfn]"); first done.
    ...
    iSteps.
  Qed.
  Lemma dynarray_1_initi𑁒spec_disentangled Ψ sz fn :
    (0 ≤ sz)%Z →
    {{{
      □ (
        ∀ i,
  ...
  Proof.
    ...
    wp_apply (dynarray_1_initi𑁒spec Ψ' with "[] HΦ"); first done.
    rewrite /Ψ'. iSteps.
  ...
  Proof.
    ...
    wp_apply (dynarray_1_initi𑁒spec' Ψ' with "[Hfn] HΦ"); first done.
    rewrite /Ψ'. iSteps.
    iApply (big_sepL_impl with "Hfn").
    iSteps. rewrite big_sepL_snoc. iSteps.
  Qed.

  Lemma dynarray_1_size𑁒spec t vs :
    {{{
      dynarray_1_model t vs
    }}}
      dynarray_1_size t
  ...
  Lemma dynarray_1_capacity𑁒spec t vs :
    {{{
      dynarray_1_model t vs
    }}}
  ...
  Lemma dynarray_1_is_empty𑁒spec t vs :
    {{{
      dynarray_1_model t vs
    }}}
  ...
  Proof.
    iIntros "%Φ Hmodel HΦ".
    wp_rec.
    wp_apply+ (dynarray_1_size𑁒spec with "Hmodel") as "Hmodel".
    wp_pures.
    destruct vs; iApply ("HΦ" with "Hmodel").
  Qed.

  Lemma dynarray_1_get𑁒spec t vs (i : Z) v :
    (0 ≤ i)%Z →
    vs !! ₊i = Some v →
    {{{
      dynarray_1_model t vs
  ...
  Proof.
    ...
    wp_rec. wp_load.
    wp_apply (array_unsafe_get𑁒spec with "Hmodel"); [lia | | done |].
    { rewrite lookup_app_l //. eapply lookup_lt_Some. done. }
    iSteps.
  Qed.

  Lemma dynarray_1_set𑁒spec t vs (i : Z) v :
    (0 ≤ i < length vs)%Z →
    {{{
      dynarray_1_model t vs
    }}}
  ...
  #[local] Lemma dynarray_1_next_capacity𑁒spec n :
    (0 ≤ n)%Z →
    {{{
      True
    }}}
  ...
  Proof.
    iSteps.
  Qed.
  #[local] Lemma dynarray_1_reserve𑁒spec' t vs n :
    (0 ≤ n)%Z →
    {{{
      dynarray_1_model t vs
    }}}
  ...
  Proof.
    ...
    - wp_apply (dynarray_1_next_capacity𑁒spec with "[//]") as "%n' %Hn'"; first lia.
      wp_apply int_max𑁒spec.
      wp_apply+ (array_unsafe_alloc𑁒spec with "[//]") as "%data' Hmodel'"; first lia.
      wp_load.
      wp_apply+ (array_unsafe_copy_slice𑁒spec with "[$Hmodel $Hmodel']") as "(Hmodel & Hmodel')"; try lia.
      { simpl_length. lia. }
      { simpl_length. lia. }
      wp_store.
    ...
    - iApply ("HΦ" $! extra).
      iSteps.
  Qed.
  Lemma dynarray_1_reserve𑁒spec t vs n :
    (0 ≤ n)%Z →
    {{{
      dynarray_1_model t vs
    }}}
  ...
  Proof.
    ...
    wp_apply (dynarray_1_reserve𑁒spec' with "Hmodel"); first done.
    iSteps.
  Qed.

  #[local] Lemma dynarray_1_reserve_extra𑁒spec' t vs n :
    (0 ≤ n)%Z →
    {{{
      dynarray_1_model t vs
    }}}
  ...
  Proof.
    iIntros "%Hn %Φ (:model) HΦ".
    wp_rec. wp_load.
    wp_apply+ (dynarray_1_reserve𑁒spec' with "[Hl_size Hl_data Hmodel]") as "%extra' (%Hextra' & Hmodel)"; [lia | iFrameSteps |].
    iApply ("HΦ" $! extra').
    iFrameSteps.
  Qed.
  Lemma dynarray_1_reserve_extra𑁒spec t vs n :
    (0 ≤ n)%Z →
    {{{
      dynarray_1_model t vs
    }}}
  ...
  Proof.
    iIntros "%Hn %Φ Hmodel HΦ".
    wp_apply (dynarray_1_reserve_extra𑁒spec' with "Hmodel"); first done.
    iSteps.
  Qed.

  Lemma dynarray_1_grow𑁒spec t vs sz v :
    (0 ≤ sz)%Z →
    {{{
      dynarray_1_model t vs
    }}}
  ...
  Proof.
    ...
    case_bool_decide.
    - wp_apply+ (dynarray_1_reserve𑁒spec' with "[$Hl_size $Hl_data $Hmodel //]") as "%extra' (%Hextra' & (:model' ='))"; first lia.
      wp_load.
      wp_apply+ (array_unsafe_fill_slice𑁒spec with "Hmodel") as "Hmodel".
      { lia. }
      { simpl_length. lia. }
      iSteps.
      { iPureIntro.
  ...
  Lemma dynarray_1_push𑁒spec t vs v :
    {{{
      dynarray_1_model t vs
    }}}
      dynarray_1_push t v
  ...
  Proof.
    iIntros "%Φ Hmodel HΦ".
    wp_rec.
    wp_apply+ (dynarray_1_reserve_extra𑁒spec' with "Hmodel") as "%extra (%Hextra & (:model'))"; first lia.
    wp_load. wp_store. wp_load.
    wp_apply (array_unsafe_set𑁒spec with "Hmodel").
    { simpl_length. lia. }
    rewrite Nat2Z.id insert_app_r_alt // Nat.sub_diag insert_replicate_lt // /= (assoc (++) vs [v] (replicate _ _)).
    iSteps. simpl_length. iSteps.
  Qed.

  Lemma dynarray_1_pop𑁒spec {t vs} vs' v :
    vs = vs' ++ [v] →
    {{{
      dynarray_1_model t vs
    }}}
  ...
  Lemma dynarray_1_fit_capacity𑁒spec t vs :
    {{{
      dynarray_1_model t vs
    }}}
  ...
  Proof.
    ...
    wp_apply (array_unsafe_shrink𑁒spec with "Hmodel") as "%data' (_ & Hmodel)".
    { simpl_length. lia. }
    wp_store.
    iSteps. iExists 0. rewrite Nat2Z.id take_app_length right_id //.
  Qed.

  Lemma dynarray_1_reset𑁒spec t vs :
    {{{
      dynarray_1_model t vs
    }}}
      dynarray_1_reset t
  ...
  Lemma dynarray_1_iteri𑁒spec Ψ fn t vs :
    {{{
      ▷ Ψ 0 [] ∗
      dynarray_1_model t vs ∗
      □ (
  ...
  Proof.
    ...
    wp_rec. do 2 wp_load.
    wp_apply (array_unsafe_iteri_slice𑁒spec Ψ with "[$HΨ $Hmodel]").
    { lia. }
    { lia. }
    { simpl_length. lia. }
  ...
  Proof.
    ...
    wp_apply (dynarray_1_iteri𑁒spec Ψ' with "[$HΨ $Hmodel $Hfn]").
    ...
    iSteps.
  Qed.
  Lemma dynarray_1_iteri𑁒spec_disentangled Ψ fn t vs :
    {{{
      dynarray_1_model t vs ∗
      □ (
        ∀ i v,
  ...
  Proof.
    ...
    wp_apply (dynarray_1_iteri𑁒spec Ψ' with "[$Hmodel]").
    { rewrite /Ψ'. iSteps.
  ...
  Proof.
    ...
    wp_apply (dynarray_1_iteri𑁒spec' Ψ' with "[$Hmodel Hfn]").
    { rewrite /Ψ'. iSteps.
  ...
  Lemma dynarray_1_iter𑁒spec Ψ fn t vs :
    {{{
      ▷ Ψ 0 [] ∗
      dynarray_1_model t vs ∗
      □ (
  ...
  Proof.
    iIntros "%Φ (HΨ & Hmodel & #Hfn) HΦ".
    wp_rec.
    wp_apply+ (dynarray_1_iteri𑁒spec Ψ with "[$HΨ $Hmodel] HΦ").
    iSteps.
  Qed.
  Lemma dynarray_1_iter𑁒spec' Ψ fn t vs :
    {{{
  ...
  Proof.
    iIntros "%Φ (HΨ & Hmodel & Hfn) HΦ".
    wp_rec.
    wp_apply+ (dynarray_1_iteri𑁒spec' Ψ with "[$HΨ $Hmodel Hfn] HΦ").
    iApply (big_sepL_impl with "Hfn").
    iSteps.
  Qed.
  Lemma dynarray_1_iter𑁒spec_disentangled Ψ fn t vs :
    {{{
      dynarray_1_model t vs ∗
      □ (
        ∀ i v,
  ...
  Proof.
    iIntros "%Φ (Hmodel & #Hfn) HΦ".
    wp_rec.
    wp_apply+ (dynarray_1_iteri𑁒spec_disentangled Ψ with "[$Hmodel] HΦ").
    iSteps.
  Qed.
  Lemma dynarray_1_iter𑁒spec_disentangled' Ψ fn t vs :
    {{{
  ...
  Proof.
    iIntros "%Φ (Hmodel & Hfn) HΦ".
    wp_rec.
    wp_apply+ (dynarray_1_iteri𑁒spec_disentangled' Ψ with "[$Hmodel Hfn] HΦ").
    iApply (big_sepL_impl with "Hfn").
    iSteps.
  Qed.
End zoo_G.
