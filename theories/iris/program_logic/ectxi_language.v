...
Section ectxi_language_mixin.
  ...
  Record EctxiLanguageMixin := {
    ...
    mixin_of_to_val e v :
      to_val e = Some v →
      of_val v = e ;
    mixin_val_stuck e1 σ1 κ e2 σ2 es ϕ :
    ...
    mixin_base_ctx_step_val Ki e σ1 κ e2 σ2 es ϕ :
      base_step (fill_item Ki e) σ1 κ e2 σ2 es ϕ →
      is_Some (to_val e) ;
  }.
...
Section ectxi_language.
  ...
  Proof.
    apply ectxi_language_mixin.
  Qed.
  Lemma base_ctx_step_val Ki e σ1 κ e2 σ2 es ϕ :
    base_step (fill_item Ki e) σ1 κ e2 σ2 es ϕ →
    is_Some (to_val e).
  Proof.
    apply ectxi_language_mixin.
  ...
  Proof.
    ...
    - done.
    - intros K K' e1 κ e1' σ1 e2 σ2 es ϕ Hfill Hred Hstep; revert K' Hfill.
