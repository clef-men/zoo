...
Section mpsc_queue_G.
  ...
  Proof.
    ...
    wp_rec.
    wp_smart_apply (mpsc_queue_node2_next_spec with "[$Hmeta $Hinv $Hhistory_elem]") as (res) "[-> | (%node' & -> & #Hhistory_elem')]"; last iSteps.
    wp_pures.
  ...
  Proof.
    ...
    { wp_smart_apply (mpsc_queue_node2_next_spec with "[$Hmeta $Hinv $Hhistory_elem_new_back]") as (res) "[-> | (%new_back' & -> & #Hhistory_elem_new_back')]"; last iSteps.
      wp_pures.
  ...
  Proof.
    ...
    wp_smart_apply (mpsc_queue_back_spec with "Hinv") as (back i) "#Hhistory_elem_back".
    wp_smart_apply (mpsc_queue_do_push_spec with "[$Hmeta $Hinv $Hhistory_elem_back $Hnew_back]").
