...
Definition inf_cl_deque_create :=
  raw.inf_cl_deque_create.

Definition inf_cl_deque_push : val :=
  λ: "t" "v",
    raw.inf_cl_deque_push "t" (ref "v").

Definition inf_cl_deque_steal : val :=
  λ: "t",
    match: raw.inf_cl_deque_steal "t" with
    | None =>
        None
    | Some "slot" =>
        ‘Some{ !"slot" }
...
Definition inf_cl_deque_pop : val :=
  λ: "t",
    match: raw.inf_cl_deque_pop "t" with
    | None =>
        None
    | Some "slot" =>
        ‘Some{ !"slot" }
...
Section inf_cl_deque_G.
  ...
  Definition inf_cl_deque_inv t :=
    raw.inf_cl_deque_inv t.
  ...
  Definition inf_cl_deque_owner t :=
    raw.inf_cl_deque_owner t.
  ...
  Lemma inf_cl_deque_owner_exclusive t :
    ...
    False.
  Proof.
    apply raw.inf_cl_deque_owner_exclusive.
  Qed.
  ...
  Proof.
    iIntros "%Φ _ HΦ".
    wp_apply (raw.inf_cl_deque_create_spec with "[//]") as (t) "(#Hinv & Hmodel & Howner)".
  ...
  Proof.
    ...
    awp_apply (raw.inf_cl_deque_push_spec with "[$Hinv $Howner]").
  ...
  Proof.
    iIntros "!> %Φ #Hinv HΦ".
    wp_rec.
    awp_smart_apply (raw.inf_cl_deque_steal_spec with "Hinv").
    iApply (aacc_aupd_commit with "HΦ"); first done. iIntros "%vs (%slots & Hmodel & Hslots)".
    iAaccIntro with "Hmodel"; iIntros "Hmodel !>"; first iSteps.
  ...
  Proof.
    iIntros "!> %Φ (#Hinv & Howner) HΦ".
    wp_rec.
    awp_smart_apply (raw.inf_cl_deque_pop_spec with "[$Hinv $Howner]").
    iApply (aacc_aupd_commit with "HΦ"); first done. iIntros "%vs (%slots & Hmodel & Hslots)".
