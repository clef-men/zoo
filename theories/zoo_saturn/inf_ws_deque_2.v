...
#[global] Instance subG𑁒inf_ws_deque_2۰Σ Σ `{zoo۰G : !ZooG Σ} :
...
Module base.
  Section inf_ws_deque_2۰G.
    ...
    Implicit Types γ : inf_ws_deque_2۰name.

    #[global] Instance inf_ws_deque_2۰name𑁒eq_dec : EqDecision inf_ws_deque_2۰name :=
      ltac:(solve_decision).
    #[global] Instance inf_ws_deque_2۰name𑁒countable :
    ...
    #[global] Instance inf_ws_deque_2۰model𑁒timeless γ vs :
      Timeless (inf_ws_deque_2۰model γ vs).
    Proof.
      apply _.
    Qed.
    #[global] Instance inf_ws_deque_2۰owner𑁒timeless γ ws :
      Timeless (inf_ws_deque_2۰owner γ ws).
    Proof.
      apply _.
    Qed.

    #[global] Instance inf_ws_deque_2۰inv𑁒persistent t γ ι :
    ...
    #[local] Lemma model𑁒owner𑁒alloc :
      ⊢ |==>
        ...
        owner' γ_model [].
    Proof.
      iMod (auth_twins𑁒alloc (auth_twins۰G := inf_ws_deque_2۰G۰model۰G) _ []) as "(%γ_model & $ & $ & $)".
      iSteps.
    Qed.
    ...
    Lemma inf_ws_deque_2۰model𑁒exclusive γ vs1 vs2 :
    ...
    Lemma inf_ws_deque_2۰owner𑁒exclusive γ ws1 ws2 :
    ...
    Qed.
    Lemma inf_ws_deque_2𑁒owner𑁒model γ ws vs :
    ...
    Proof.
      ...
      iApply wp𑁒fupd.
      wp۰apply (inf_ws_deque_1٠create𑁒spec with "[//]") as (t γ_base) "(Hmeta & #Hbase_inv & Hbase_model & Hbase_owner)".
    ...
    Proof.
      ...
      awp۰apply (inf_ws_deque_1٠size𑁒spec with "[$]").
    ...
    Proof.
      ...
      awp۰apply (inf_ws_deque_1٠is_empty𑁒spec with "[$]").
      iInv "Hinv" as "(:inv۰inner)".
      iApply (aacc𑁒aupd𑁒commit with "HΦ"). 1: solve_ndisj. iIntros "%vs_ (:model)".
      iAaccIntro with "Hbase_model". 1: iSteps.
      iDestruct (model𑁒owner𑁒agree with "Howner Hmodel₁ Hmodel₂") as %(Hsuffix & ->).
    ...
    Proof.
      ...
      awp۰apply (inf_ws_deque_1٠push𑁒spec with "[$]").
      iInv "Hinv" as "(:inv۰inner)".
      iApply (aacc𑁒aupd𑁒commit with "HΦ"). 1: solve_ndisj. iIntros "%vs_ (:model)".
      iAaccIntro with "Hbase_model". 1: iSteps.
      iDestruct (model𑁒owner𑁒agree with "Howner Hmodel₁ Hmodel₂") as %(Hsuffix & ->).
    ...
    Proof.
      ...
      awp۰apply (inf_ws_deque_1٠steal𑁒spec with "[$]").
      iInv "Hinv" as "(:inv۰inner)".
      iApply (aacc𑁒aupd𑁒commit with "HΦ"). 1: solve_ndisj. iIntros "%vs_ (:model)".
    ...
    Proof.
      ...
      awp۰apply+ (inf_ws_deque_1٠pop𑁒spec with "[$]").
      iInv "Hinv" as "(:inv۰inner)".
      iApply (aacc𑁒aupd𑁒commit with "HΦ"). 1: solve_ndisj. iIntros "%vs_ (:model)".
...
Section inf_ws_deque_2۰G.
  ...
  #[global] Instance inf_ws_deque_2۰inv𑁒persistent t ι :
    Persistent (inf_ws_deque_2۰inv t ι).
  Proof.
    apply _.
  Qed.

  Lemma inf_ws_deque_2۰model𑁒exclusive t vs1 vs2 :
  ...
  Proof.
    ...
    iApply (base.inf_ws_deque_2۰model𑁒exclusive with "Hmodel_1 Hmodel_2").
  Qed.

  Lemma inf_ws_deque_2۰owner𑁒exclusive t ws1 ws2 :
  ...
  Proof.
    ...
    iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %->.
    iApply (base.inf_ws_deque_2۰owner𑁒exclusive with "Howner_1 Howner_2").
  Qed.
  Lemma inf_ws_deque_2𑁒owner𑁒model γ ws vs :
    inf_ws_deque_2۰owner γ ws -∗
    inf_ws_deque_2۰model γ vs -∗
  ...
  Proof.
    ...
    iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %->.
    iApply (base.inf_ws_deque_2𑁒owner𑁒model with "Howner_1 Hmodel_2").
  Qed.
  ...
  Proof.
    ...
    iApply wp𑁒fupd.
    wp۰apply (base.inf_ws_deque_2٠create𑁒spec with "[//]") as (𝑡 γ) "(Hmeta & Hinv & Hmodel)".
  ...
  Proof.
    ...
    awp۰apply (base.inf_ws_deque_2٠size𑁒spec with "[$]").
  ...
  Proof.
    ...
    awp۰apply (base.inf_ws_deque_2٠is_empty𑁒spec with "[$]").
    { iApply (aacc𑁒aupd𑁒commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
      iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %<-. iClear "Hmeta_2".
      iAaccIntro with "Hmodel_1"; iSteps.
    }
  ...
  Proof.
    ...
    awp۰apply (base.inf_ws_deque_2٠push𑁒spec with "[$]").
    { iApply (aacc𑁒aupd𑁒commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
      iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %<-. iClear "Hmeta_2".
      iAaccIntro with "Hmodel_1"; iSteps.
    }
  ...
  Proof.
    ...
    awp۰apply (base.inf_ws_deque_2٠steal𑁒spec with "[$]").
    { iApply (aacc𑁒aupd𑁒commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
  ...
  Proof.
    ...
    awp۰apply (base.inf_ws_deque_2٠pop𑁒spec with "[$]").
    { iApply (aacc𑁒aupd𑁒commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
      iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %<-. iClear "Hmeta_2".
