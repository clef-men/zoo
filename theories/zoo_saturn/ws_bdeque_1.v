...
#[global] Instance subG𑁒ws_bdeque_1۰Σ Σ `{zoo۰G : !ZooG Σ} :
...
Module base.
  Section ws_bdeque_1۰G.
    ...
    #[global] Instance ws_bdeque_1۰name𑁒eq_dec : EqDecision ws_bdeque_1۰name :=
      ltac:(solve_decision).
    #[global] Instance ws_bdeque_1۰name𑁒countable :
    ...
    #[global] Instance ws_bdeque_1۰model𑁒timeless γ vs :
      Timeless (ws_bdeque_1۰model γ vs).
    Proof.
      apply _.
    Qed.
    #[global] Instance ws_bdeque_1۰owner𑁒timeless t γ ws :
      Timeless (ws_bdeque_1۰owner t γ ws).
    Proof.
      apply _.
    Qed.

    #[global] Instance ws_bdeque_1۰inv𑁒persistent t γ ι cap :
    ...
    Proof.
      iMod (auth_twins𑁒alloc _ (auth_twins۰G := ws_bdeque_1۰G۰model۰G)) as "(%γ_model & Hmodel_auth & Hmodel₁ & Hmodel₂)".
      iMod (twins𑁒alloc' (twins۰G := ws_bdeque_1۰G۰owner۰G)) as "(%γ_owner & Howner₁ & Howner₂)".
      iFrameSteps.
    Qed.
    ...
    Proof.
      ...
      iSteps.
    Qed.
    #[local] Lemma model𑁒empty {γ stable back ws vs1 vs2} :
      owner₁ γ stable back ws -∗
      model₁ γ vs1 -∗
      model₂ γ vs2 ==∗
        owner₁ γ stable back [] ∗
    ...
    Qed.
    #[local] Lemma model𑁒pop γ stable back ws vs1 vs2 :
      owner₁ γ stable back ws -∗
      model₁ γ vs1 -∗
      model₂ γ vs2 ==∗
    ...
    Proof.
      ...
      iSteps.
    Qed.
    #[local] Lemma model𑁒pop' γ stable back ws vs1 v vs2 :
      owner₁ γ stable back ws -∗
      model₁ γ (vs1 ++ [v]) -∗
      model₂ γ vs2 ==∗
    ...
    Qed.
    #[local] Lemma owner𑁒agree γ stable1 back1 ws stable2 back2 :
    ...
    Proof.
      ...
      iSteps.
    Qed.
    #[local] Lemma owner𑁒update {γ stable1 back1 ws stable2 back2} stable back :
      owner₁ γ stable1 back1 ws -∗
      owner₂ γ stable2 back2 ==∗
        owner₁ γ stable back ws ∗
        owner₂ γ stable back.
    ...
    Lemma ws_bdeque_1۰model𑁒valid t γ ι cap vs :
    ...
    Proof.
      iSteps.
    Qed.
    Lemma ws_bdeque_1۰model𑁒exclusive γ vs1 vs2 :
    ...
    #[local] Lemma owner۰2𑁒rebase {t γ stable back ws front_cache i1 us} i2 :
      0 < γ.(ws_bdeque_1۰name۰capacity) →
    ...
    Lemma ws_bdeque_1۰owner𑁒exclusive t γ ws1 ws2 :
    ...
    Qed.
    Lemma ws_bdeque_1۰owner𑁒model t γ ws vs :
    ...
    #[local] Lemma inv۰state𑁒Stable γ state front back hist vs priv prophs :
      length vs = back - front →
    ...
    Qed.
    #[local] Lemma inv۰state𑁒Unstable γ state front back hist vs priv prophs :
    ...
    Proof.
      ...
      - iDestruct "Hstate" as "(:inv۰state۰superempty lazy=)".
        iSteps.
    Qed.
    #[local] Lemma inv۰state𑁒Nonempty γ state stable front back hist vs priv prophs :
      front < back →
      inv۰state γ state stable front back hist vs priv prophs ⊢
      ⌜state = Nonempty⌝.
    Proof.
    ...
    Qed.
    #[local] Lemma inv۰state𑁒Superempty γ state front back hist vs priv prophs :
      back < front →
      inv۰state γ state Unstable front back hist vs priv prophs -∗
      ⌜state = Superempty⌝.
    Proof.
      ...
      - done.
    Qed.
    #[local] Lemma inv۰state𑁒winner۰pop γ state stable front1 back hist vs priv prophs front2 P :
    ...
    Proof.
      ...
      - iDestruct "Hstate" as "(:inv۰state۰superempty)".
        ...
        iDestruct (winner۰pop𑁒exclusive with "Hwinner_pop Hwinner_pop_3") as %[].
    Qed.
    #[local] Lemma inv۰state𑁒winner۰steal γ state stable front1 back hist vs priv prophs front2 P :
      inv۰state γ state stable front1 back hist vs priv prophs -∗
    ...
    Proof.
      ...
      wp۰apply (array٠unsafe_make𑁒spec with "[//]") as (data) "Hdata_model"; first lia.
      iDestruct (array۰model𑁒to𑁒cslice with "Hdata_model") as "Hdata_cslice".
      iEval (simpl_length) in "Hdata_cslice".
      iDestruct (array۰cslice𑁒rotation𑁒right𑁒0 1 with "Hdata_cslice") as "Hdata_cslice"; [simpl_length; lia.. |].
      iEval (rewrite rotation𑁒replicate) in "Hdata_cslice".
      iDestruct "Hdata_cslice" as "(Hdata_cslice₁ & Hdata_cslice₂)".

      wp۰block t as "Hmeta" "(Ht_capacity & Ht_front & Ht_front_cache & Ht_back & Ht_data & Ht_proph & _)".
      iMod (pointsto𑁒persist with "Ht_capacity") as "#Ht_capacity".
      ...
      iDestruct (front۰lb𑁒get γ with "Hfront_auth") as "#Hfront_lb".
    ...
    Proof.
      ...
      iFrameSteps.
    Qed.
    #[local] Lemma front𑁒spec𑁒owner𑁒Stable t γ back ws :
      {{{
        inv' t γ ∗
        owner₁ γ Stable back ws
      }}}
    ...
    Proof.
      ...
      iFrameSteps.
    Qed.
    #[local] Lemma front𑁒spec𑁒owner𑁒Unstable t γ back ws :
      {{{
        inv' t γ ∗
    ...
    Proof.
      ...
      iFrameSteps.
    Qed.
    #[local] Lemma front𑁒spec𑁒Superempty t γ back ws front :
      back < front →
      {{{
        inv' t γ ∗
        owner₁ γ Unstable back ws ∗
    ...
    #[local] Lemma set_back𑁒spec𑁒Superempty t γ back ws front (back' : Z) :
      back < front →
      back' = ˖back →
      {{{
        inv' t γ ∗
    ...
    #[local] Lemma array٠unsafe_cget𑁒spec𑁒loser t γ i :
      (0 ≤ i)%Z →
      {{{
        inv' t γ
      }}}
    ...
    Proof.
      ...
      iApply wp𑁒fupd.
      awp۰apply (array٠unsafe_cget𑁒spec𑁒atomic𑁒weak with "[//]") without "HΦ"; first done.
      iInv "Hinv" as "(:inv۰inner)".
    ...
    Qed.
    #[local] Lemma array٠unsafe_cget𑁒spec𑁒winner۰pop t γ front P v :
      {{{
        inv' t γ ∗
        winner۰pop γ front P ∗
        history۰at γ front v
    ...
    #[local] Lemma array٠unsafe_cset𑁒spec𑁒owner t γ back ws front_cache us front v :
    ...
    Proof.
      ...
      iDestruct (array۰cslice𑁒app with "Hdata_cslice₁") as "(Hdata_cslice₁_1 & Hdata_cslice₁_2)".
    ...
    Proof.
      ...
      - iDestruct (front۰lb𑁒get with "Hfront_auth") as "#-#Hfront_lb_1".
        ...
        iSteps.
    Qed.
    #[local] Lemma resolve𑁒spec𑁒winner۰pop t γ front P id :
      {{{
        inv' t γ ∗
        winner۰pop γ front P
      }}}
    ...
    Proof.
      ...
      - iDestruct "Hwinner" as "(:winner۰pending₁)".
        ...
        iDestruct (array۰cslice𑁒rotation𑁒right₁' ˖front 1 with "Hdata_cslice₁") as "Hdata_cslice₁"; [simpl_length/=; lia.. |].
      ...
      - assert (length vs1 = 0) as ->%nil_length_inv by lia.
        ...
        iDestruct (array۰cslice𑁒rotation𑁒right₁' ˖back1 1 with "Hdata_cslice₁") as "Hdata_cslice₁"; [simpl_length; lia.. |].
    ...
    Proof.
      ...
      iSteps.
    Qed.
    #[local] Lemma resolve𑁒spec𑁒Empty t γ back ws id :
      {{{
        inv' t γ ∗
        owner₁ γ Stable back ws ∗
        front۰lb γ back
    ...
    Proof.
      ...
      - iDestruct "Hstate" as "(:inv۰state۰empty =1 lazy=)".
        ...
        iDestruct (array۰cslice𑁒rotation𑁒right₁' ˖(length hist1) 1 with "Hdata_cslice₁") as "Hdata_cslice₁"; [simpl_length; lia.. |].
        iEval (rewrite -(app_nil_l (rotation _ _ ))) in "Hdata_cslice₁".
    ...
    Proof.
      ...
      wp۰rec.
      wp۰apply (ws_bdeque_1٠size𑁒spec with "[$]").
    ...
    Proof.
      iIntros "%Φ ((:inv) & (:owner)) HΦ".
      rename us into us0. iDestruct (owner۰2𑁒rebase back with "Howner") as "(%us & (:owner۰2))"; first done.
      ...
      { case_bool_decide; wp۰pures.
        ...
        - wp۰rec.
          ...
          { iInv "Hinv" as "(:inv۰inner =1)".
            wp۰load.
            iDestruct (owner𑁒agree with "Howner₁ Howner₂") as %(<- & <-).
            iDestruct (front۰lb𑁒get with "Hfront_auth") as "#$".
      ...
      - iDestruct "HΦ" as "(%Hfront_cache & HΦ)".
        ...
        wp۰apply (array٠unsafe_cset𑁒spec𑁒owner with "[$Howner₁ $Ht_front_cache $Hdata_cslice₂]") as "(:owner۰2 !=)"; [done | iSteps |].
        wp۰pures.
        ...
        iDestruct (front۰lb𑁒valid with "Hfront_auth Hfront_lb_cache") as %?.

        iAssert ⌜head priv2 = Some v⌝%I as %(priv2' & ->)%head_Some.
        { iDestruct (array۰cslice𑁒rotation𑁒right𑁒small₁' back (length vs2) with "Hdata_cslice₁") as "Hdata_cslice₁"; [simpl_length; lia.. |].
    ...
    Proof.
      ...
      wp۰apply+ front𑁒spec as (front1) "#Hfront_lb_1"; first iSteps.
      wp۰pures.
      ...
      { assert (front1 < front2) as Hbranch2 by lia.
        ...
        rewrite bool_decide_eq_false_2; first lia.
        wp۰load.
        wp۰apply+ array٠unsafe_cget𑁒spec𑁒loser as (v) "_"; [lia | iSteps |].
        wp۰load.
        wp۰apply+ resolve𑁒spec𑁒loser₁; [done | iSteps |].
        iSteps.
      }
      ...
      rewrite bool_decide_eq_false_2; first lia.
      wp۰load.
      wp۰apply+ (array٠unsafe_cget𑁒spec𑁒winner۰pop with "[$Hwinner_pop]") as "Hwinner_pop"; first iSteps.
      wp۰load.
      wp۰apply+ (resolve𑁒spec𑁒winner۰pop with "[$Hwinner_pop]") as "HΦ"; first iSteps.
      iSteps.
    Qed.
    ...
    Proof.
      ...
      - iDestruct "H" as "(-> & %Hus_lookup)".
        ...
        wp۰apply (front𑁒spec𑁒owner𑁒Stable with "[$Howner₁]") as (front2) "(Howner₁ & #Hfront_lb & %Hfront2)"; first iSteps.
        wp۰pures.
        rewrite bool_decide_eq_false_2; first lia.
        wp۰pures.
        ...
        + wp۰load.
          wp۰apply (array٠unsafe_cget𑁒spec with "Hdata_cslice₂"); [done.. | lia |].
          iSteps.

        + replace front2 with back by lia.

          wp۰store. wp۰load.
          wp۰apply+ (resolve𑁒spec𑁒Empty with "[$Howner₁]") as "{Hfront_lb} (Howner₁ & #Hfront_lb)"; first iSteps.
          wp۰apply+ (set_back𑁒spec𑁒Superempty with "[$Howner₁ $Hfront_lb]") as "Howner₁"; [lia.. | iSteps |].
          wp۰load.
      ...
      - iDestruct "H" as "(-> & %Hus_lookup & Hwinner_steal)".
        ...
        wp۰apply (front𑁒spec𑁒winner۰steal with "[$Hwinner_steal]") as "Hwinner_steal"; first iSteps.
        wp۰pures.
        rewrite bool_decide_eq_false_2; first lia.
        wp۰pures.
        rewrite bool_decide_eq_false_2; first lia.
        wp۰store. wp۰load.
        wp۰apply+ (resolve𑁒spec𑁒winner۰steal with "[$Hwinner_steal]") as "#Hfront_lb"; first iSteps.
        wp۰apply+ (set_back𑁒spec𑁒Superempty with "[$Howner₁ $Hfront_lb]") as "Howner₁"; [lia.. | iSteps |].
        wp۰load.
        wp۰apply (array٠unsafe_cget𑁒spec with "Hdata_cslice₂") as "Hdata_cslice₂"; [done.. | lia |].
        wp۰pures.
      ...
      - iDestruct "H" as "(%id_winner & %prophs & -> & #Hprophet_full & %Hloser)".
        ...
        wp۰apply (front𑁒spec𑁒owner𑁒Unstable with "[$Howner₁]") as (front2) "(Howner₁ & #Hfront_lb & %Hbranch)"; first iSteps.
        wp۰pures.
        destruct Hbranch as [-> | ->].
        ...
        + rewrite bool_decide_eq_false_2; first lia.
          ...
          rewrite bool_decide_eq_false_2; first lia.
          wp۰store. wp۰load.
          wp۰apply+ (resolve𑁒spec𑁒loser₂ with "[$Hfront_lb $Hprophet_full]") as "{Hfront_lb} #Hfront_lb"; [done | iSteps |].
          wp۰apply+ (set_back𑁒spec𑁒Superempty with "[$Howner₁ $Hfront_lb]") as "Howner₁"; [lia.. | iSteps |].
          wp۰pures.
      ...
      - iDestruct "H" as "(%front & -> & #Hfront_lb & ->)".
        ...
        wp۰apply (front𑁒spec𑁒Superempty with "[$Howner₁ $Hfront_lb]") as "Howner₁"; [lia | iSteps |].
        wp۰pures.
        rewrite bool_decide_eq_true_2; first lia.
        wp۰apply+ (set_back𑁒spec𑁒Superempty with "[$Howner₁ $Hfront_lb]") as "Howner₁"; [lia.. | iSteps |].
        iSteps.
    ...
    Proof.
      iIntros "%Φ ((:inv) & (:owner)) HΦ".
      rename us into us0. iDestruct (owner۰2𑁒rebase (back - 1) with "Howner") as "(%us & (:owner۰2))"; first done.
      ...
      { iDestruct "Hstate" as "(:inv۰state۰empty =1 lazy=)".
        ...
        iDestruct (front۰lb𑁒get with "Hfront_auth") as "#Hfront_lb".
        iMod (owner𑁒update Unstable (back - 1) with "Howner₁ Howner₂") as "(Howner₁ & Howner₂)".
        ...
        wp۰apply+ (ws_bdeque_1٠pop₀𑁒spec PopSuperempty (back - 1) with "[- HΦ]"); [lia | iFrameSteps |].
        iSteps.
      }
      ...
      - assert (length vs1 = 0) as ->%nil_length_inv.
        ...
        { iDestruct (array۰cslice𑁒agree with "Hdata_cslice₁ Hdata_cslice₂") as %<-; first (simpl; lia).
          iSteps.
        }

        iMod (owner𑁒update Unstable front1 with "Howner₁ Howner₂") as "(Howner₁ & Howner₂)".
        ...
        + rewrite Hprophss1.
          ...
          wp۰apply+ (ws_bdeque_1٠pop₀𑁒spec (PopEmptyishWinner v) front1 with "[- HΦ]"); [lia | iFrameSteps |].
          iSteps.
        ...
        + iDestruct "Hwinner" as "[(:winner) | Hwinner]".
          ...
          wp۰apply+ (ws_bdeque_1٠pop₀𑁒spec PopEmptyishLoser front1 with "[- HΦ]"); [lia | iFrameSteps |].
          iSteps.

      - iMod (owner𑁒update Stable (back - 1) with "Howner₁ Howner₂") as "(Howner₁ & Howner₂)".
        ...
        iAssert ⌜us !! 0 = Some v⌝%I as %Hus_lookup.
        { iDestruct (array۰cslice𑁒rotation𑁒right𑁒small₁' (back - 1) (length vs1) with "Hdata_cslice₁") as "Hdata_cslice₁"; [simpl_length/=; lia.. |].
          iDestruct (array۰cslice𑁒agree with "Hdata_cslice₁ Hdata_cslice₂") as %<-.
          { simpl_length/=. lia. }
          rewrite /rotation drop_app_length //.
        }
        ...
        wp۰apply+ (ws_bdeque_1٠pop₀𑁒spec (PopNonempty v) (back - 1) with "[- HΦ]"); [lia | iFrameSteps |].
        iSteps.
    Qed.
  End ws_bdeque_1۰G.
...
Section ws_bdeque_1۰G.
  ...
  Proof.
    apply _.
  Qed.
  #[global] Instance ws_bdeque_1۰owner𑁒timeless γ ws :
    Timeless (ws_bdeque_1۰owner γ ws).
  Proof.
    apply _.
  Qed.

  #[global] Instance ws_bdeque_1۰inv𑁒persistent t ι cap :
    Persistent (ws_bdeque_1۰inv t ι cap).
  Proof.
    apply _.
  Qed.

  Lemma ws_bdeque_1۰model𑁒valid t ι cap vs :
  ...
  Proof.
    ...
    iApply (base.ws_bdeque_1۰model𑁒valid with "Hinv_1 Hmodel_2").
  Qed.
  Lemma ws_bdeque_1۰model𑁒exclusive t vs1 vs2 :
  ...
  Proof.
    ...
    iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %->.
    iApply (base.ws_bdeque_1۰model𑁒exclusive with "Hmodel_1 Hmodel_2").
  Qed.

  Lemma ws_bdeque_1۰owner𑁒exclusive t ws1 ws2 :
  ...
  Proof.
    ...
    iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %->.
    iApply (base.ws_bdeque_1۰owner𑁒exclusive with "Howner_1 Howner_2").
  Qed.
  Lemma ws_bdeque_1𑁒owner𑁒model γ ws vs :
  ...
  Proof.
    ...
    iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %->.
    iApply (base.ws_bdeque_1۰owner𑁒model with "Howner_1 Hmodel_2").
  Qed.
  ...
  Proof.
    ...
    iApply wp𑁒fupd.
    wp۰apply (base.ws_bdeque_1٠create𑁒spec with "[//]") as (𝑡 γ) "(Hmeta & Hinv & Hmodel & Howner)"; first done.
  ...
  Proof.
    ...
    wp۰apply (base.ws_bdeque_1٠capacity𑁒spec with "[$] HΦ").
  Qed.
  ...
  Proof.
    ...
    awp۰apply (base.ws_bdeque_1٠size𑁒spec with "[$]").
  ...
  Proof.
    ...
    awp۰apply (base.ws_bdeque_1٠is_empty𑁒spec with "[$]").
    { iApply (aacc𑁒aupd𑁒commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
      iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %<-. iClear "Hmeta_2".
      iAaccIntro with "Hmodel_1"; iSteps.
    }
  ...
  Proof.
    ...
    awp۰apply (base.ws_bdeque_1٠push𑁒spec with "[$]").
    { iApply (aacc𑁒aupd𑁒commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
      iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %<-. iClear "Hmeta_2".
      iAaccIntro with "Hmodel_1"; iSteps.
    }
  ...
  Proof.
    ...
    awp۰apply (base.ws_bdeque_1٠steal𑁒spec with "[$]").
    { iApply (aacc𑁒aupd𑁒commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
  ...
  Proof.
    ...
    awp۰apply (base.ws_bdeque_1٠pop𑁒spec with "[$]").
    { iApply (aacc𑁒aupd𑁒commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
      iDestruct (meta𑁒agree with "Hmeta_1 Hmeta_2") as %<-. iClear "Hmeta_2".
