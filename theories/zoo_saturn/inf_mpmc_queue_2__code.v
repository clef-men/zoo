...
Notation "'inf_mpmc_queue_2٠data'" := (
  in_type "zoo_saturn.inf_mpmc_queue_2.t" 0
)(in custom zoo_field
).
Notation "'inf_mpmc_queue_2٠front'" := (
  in_type "zoo_saturn.inf_mpmc_queue_2.t" 1
)(in custom zoo_field
).
Notation "'inf_mpmc_queue_2٠back'" := (
  in_type "zoo_saturn.inf_mpmc_queue_2.t" 2
)(in custom zoo_field
).
Notation "'inf_mpmc_queue_2٠proph'" := (
...
Definition inf_mpmc_queue_2٠size : val :=
  𝗿𝗲𝗰 "size" "t" ->
    𝗹𝗲𝘁 "front" = "t".{inf_mpmc_queue_2٠front} 𝗶𝗻
    𝗹𝗲𝘁 "proph" = 𝗽𝗿𝗼𝗽𝗵 𝗶𝗻
    𝗹𝗲𝘁 "back" = "t".{inf_mpmc_queue_2٠back} 𝗶𝗻
    𝗶𝗳
      (𝗹𝗲𝘁 "@tmp" = "t".{inf_mpmc_queue_2٠front} 𝗶𝗻
...
Definition inf_mpmc_queue_2٠push : val :=
  𝗿𝗲𝗰 "push" "t" "v" ->
    𝗹𝗲𝘁 "id" = 𝗶𝗱 𝗶𝗻
    𝗹𝗲𝘁 "i" = 𝗳𝗮𝗮 "t".[inf_mpmc_queue_2٠back] 1 𝗶𝗻
    𝗶𝗳
      ~
      inf_array٠cas_resolve
        "t".{inf_mpmc_queue_2٠data}
        "i"
        §optional٠Nothing
        ‘optional٠Something( "v" )
        "t".{inf_mpmc_queue_2٠proph}
        ("i", "id")
    𝘁𝗵𝗲𝗻 (
      "push" "t" "v"
    ).
...
Definition inf_mpmc_queue_2٠pop : val :=
  𝗿𝗲𝗰 "pop" "t" ->
    𝗹𝗲𝘁 "id" = 𝗶𝗱 𝗶𝗻
    𝗹𝗲𝘁 "i" = 𝗳𝗮𝗮 "t".[inf_mpmc_queue_2٠front] 1 𝗶𝗻
    𝗺𝗮𝘁𝗰𝗵
