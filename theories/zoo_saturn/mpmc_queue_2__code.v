...
Definition mpmc_queue_2٠prefix_index : val :=
  𝗳𝘂𝗻 "pref" ->
    𝗺𝗮𝘁𝗰𝗵 "pref" 𝘄𝗶𝘁𝗵
    | mpmc_queue_2٠Back ⎽ ⎽ 𝗮𝘀 "back_r" ->
        "back_r".{mpmc_queue_2٠index}
    | mpmc_queue_2٠Snoc "i" ⎽ ⎽ ->
        "i"
    𝗲𝗻𝗱.
...
Definition mpmc_queue_2٠rev₁ : val :=
  𝗿𝗲𝗰 "rev" "suff" "pref" ->
    𝗺𝗮𝘁𝗰𝗵 "suff" 𝘄𝗶𝘁𝗵
    | mpmc_queue_2٠Cons ⎽ ⎽ ⎽ 𝗮𝘀 "suff" ->
        𝗺𝗮𝘁𝗰𝗵 "pref" 𝘄𝗶𝘁𝗵
        | mpmc_queue_2٠Back ⎽ ⎽ ->
            "suff"
        | mpmc_queue_2٠Snoc "i" "v" "pref" ->
            "rev" ‘mpmc_queue_2٠Cons[ "i", "v", "suff" ] "pref"
        𝗲𝗻𝗱
    𝗲𝗻𝗱.
...
Definition mpmc_queue_2٠create : val :=
  𝗳𝘂𝗻 ⎽ ->
    { ‘mpmc_queue_2٠Front[ 1 ],
      ‘mpmc_queue_2٠Back{ 0, §mpmc_queue_2٠Used }
    }.

Definition mpmc_queue_2٠size : val :=
  𝗿𝗲𝗰 "size" "t" ->
    𝗹𝗲𝘁 "front" = "t".{mpmc_queue_2٠front} 𝗶𝗻
    𝗹𝗲𝘁 "proph" = 𝗽𝗿𝗼𝗽𝗵 𝗶𝗻
    𝗹𝗲𝘁 "back" = "t".{mpmc_queue_2٠back} 𝗶𝗻
    𝗶𝗳
      𝗹𝗲𝘁 "@tmp" = "t".{mpmc_queue_2٠front} == "front" 𝗶𝗻
...
Definition mpmc_queue_2٠finish : val :=
  𝗳𝘂𝗻 "back" ->
    𝗺𝗮𝘁𝗰𝗵 "back" 𝘄𝗶𝘁𝗵
    | mpmc_queue_2٠Back ⎽ ⎽ 𝗮𝘀 "back_r" ->
        "back_r" <-{mpmc_queue_2٠move} §mpmc_queue_2٠Used
    𝗲𝗻𝗱.

Definition mpmc_queue_2٠help : val :=
  𝗳𝘂𝗻 "t" "back" "i_move" "move" ->
    𝗺𝗮𝘁𝗰𝗵 "t".{mpmc_queue_2٠front} 𝘄𝗶𝘁𝗵
    | mpmc_queue_2٠Front "i_front" 𝗮𝘀 "front" ->
        𝗶𝗳
          "i_move" < "i_front"
          𝗼𝗿
          𝗰𝗮𝘀
            "t".[mpmc_queue_2٠front]
            "front"
            (mpmc_queue_2٠rev "move")
        𝘁𝗵𝗲𝗻 (
...
#[local] Definition __zoo_recs_0 :=
  ( 𝗿𝗲𝗰𝘀 "push_aux" "t" "v" "i" "back" ->
      𝗹𝗲𝘁 "new_back" =
        ‘mpmc_queue_2٠Snoc[ "i" + 1, "v", "back" ]
      𝗶𝗻
      𝗶𝗳
        ~ 𝗰𝗮𝘀 "t".[mpmc_queue_2٠back] "back" "new_back"
      𝘁𝗵𝗲𝗻 (
        domain٠yield () ⍮
        "push" "t" "v"
      )
    𝘄𝗶𝘁𝗵 "push" "t" "v" ->
      𝗺𝗮𝘁𝗰𝗵 "t".{mpmc_queue_2٠back} 𝘄𝗶𝘁𝗵
      | mpmc_queue_2٠Snoc "i" ⎽ ⎽ 𝗮𝘀 "back" ->
          "push_aux" "t" "v" "i" "back"
      | mpmc_queue_2٠Back ⎽ ⎽ 𝗮𝘀 "back" ->
          𝗹𝗲𝘁 "back_r" = "back" 𝗶𝗻
          𝗺𝗮𝘁𝗰𝗵 "back_r".{mpmc_queue_2٠move} 𝘄𝗶𝘁𝗵
          | mpmc_queue_2٠Used ->
              "push_aux" "t" "v" "back_r".{mpmc_queue_2٠index} "back"
          | mpmc_queue_2٠Snoc "i_move" ⎽ ⎽ 𝗮𝘀 "move" ->
...
#[local] Definition __zoo_recs_1 :=
  ( 𝗿𝗲𝗰𝘀 "pop_1" "t" "front" ->
      𝗺𝗮𝘁𝗰𝗵 "front" 𝘄𝗶𝘁𝗵
      | mpmc_queue_2٠Cons ⎽ "v" "new_front" ->
          𝗶𝗳
            𝗰𝗮𝘀 "t".[mpmc_queue_2٠front] "front" "new_front"
          𝘁𝗵𝗲𝗻 (
            ‘Some( "v" )
          ) 𝗲𝗹𝘀𝗲 (
            domain٠yield () ⍮
      ...
      | mpmc_queue_2٠Front "i_front" 𝗮𝘀 "front" ->
          𝗺𝗮𝘁𝗰𝗵 "t".{mpmc_queue_2٠back} 𝘄𝗶𝘁𝗵
          | mpmc_queue_2٠Snoc "i_move" "v" "move_pref" 𝗮𝘀 "move" ->
              𝗶𝗳 "i_front" == "i_move" 𝘁𝗵𝗲𝗻 (
                𝗶𝗳
                  𝗰𝗮𝘀 "t".[mpmc_queue_2٠back] "move" "move_pref"
                𝘁𝗵𝗲𝗻 (
                  ‘Some( "v" )
                ) 𝗲𝗹𝘀𝗲 (
                  "pop" "t"
                ...
                | mpmc_queue_2٠Back ⎽ ⎽ 𝗮𝘀 "back" ->
                    ...
                    𝗶𝗳 "front'" != "front" 𝘁𝗵𝗲𝗻 (
                      "pop_1" "t" "front'"
                       ...
                       𝗰𝗮𝘀 "t".[mpmc_queue_2٠back] "move" "back"
                     𝘁𝗵𝗲𝗻 (
