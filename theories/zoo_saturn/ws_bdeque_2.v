...
Module base.
  Section ws_bdeque_2۰G.
    ...
    Please derive EqDecision for ws_bdeque_2۰name.
    Please derive Countable for ws_bdeque_2۰name.
    ...
    #[local] Definition inv۰inner γ : iProp Σ :=
      ∃ vs slots,
      ws_bdeque_1۰model γ.(ws_bdeque_2۰name۰base) (#*ˡ slots) ∗
      model₂ γ vs ∗
    ...
    Proof.
      ...
      iFrame "# Hmeta Hmodel₁ Howner". iSplitR "Hbase_owner"; iStep.
      - iApply inv_alloc.
        iExists [], []. iFrameSteps.
      - iExists []. iFrameSteps.
    Qed.
