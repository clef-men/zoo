...
Section ws_hub_fifo_G.
  ...
  #[local] Lemma ws_hub_fifo_steal_0_spec t ι (sz : nat) i :
    (0 ≤ i < sz)%Z →
    <<<
      ws_hub_fifo_inv t ι sz
    | ∀∀ vs,
  ...
  Proof.
    ...
    wp_rec. wp_load.
    wp_apply+ (waiters_prepare_wait_spec with "Hwaiters_inv") as "_". 1: done.
    wp_apply+ ws_hub_fifo_closed_spec as ([]) "_". 1: iSteps.
    ...
    - wp_load.
      ...
      { destruct b; wp_pures.
        all: wp_load.
        1: wp_apply (waiters_commit_wait_spec with "Hwaiters_inv"); first done.
        2: wp_apply (waiters_cancel_wait_spec with "Hwaiters_inv"); first done.
        all: iSteps.
      }
  ...
  Proof.
    ...
    wp_rec.
    wp_apply+ (ws_hub_fifo_begin_inactive_spec with "Hinv") as "_".
    wp_apply+ (ws_hub_fifo_steal_0_spec with "Hinv"). 1: lia.
