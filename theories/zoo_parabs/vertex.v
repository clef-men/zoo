...
Zoo global
  { stack : stack_mpmc_2 : zoo
  ; state : twins (leibnizO state) : zoo
  ; iteration : twins (leibnizO vertex۰iteration) : zoo
  ; dependencies : mono_gmultiset vertex۰name : zoo
  ; predecessors : auth_gmultiset vertex۰name : zoo
  ; output : subprops : zoo
  }
